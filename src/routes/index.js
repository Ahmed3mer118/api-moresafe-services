...
router.post('/custodies', authenticate, authorize(ROLES.PROJECT_MANAGER, ROLES.PROJECT_ACCOUNTANT), custodyCtrl.createCustody);
...
// Finance extras
router.get('/vouchers', authenticate, authorize(ROLES.CHIEF_ACCOUNTANT), dashboardCtrl.listVouchers);
router.post('/vouchers', authenticate, authorize(ROLES.CHIEF_ACCOUNTANT), dashboardCtrl.createVoucher);
